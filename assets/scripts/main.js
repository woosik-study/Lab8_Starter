  ...
  if ('serviceWorker' in navigator) {
    ...
    window.addEventListener('load', () => {
      ...
      navigator.serviceWorker
        .register('./sw.js')
        .then((registration) => {
          // B4. Console log on successful registration
          console.log('ServiceWorker registration successful with scope: ', registration.scope);
        })
        .catch((err) => {
          // B5. Console log if registration fails
...
async function getRecipes() {
  ...
  return new Promise((resolve, reject) => {
    // A4. Loop through each recipe URL in the RECIPE_URLS array
    RECIPE_URLS.forEach(async (url) => {
      // A5. try/catch block for async fetch
      try {
        // A6. Fetch the URL
        ...
        // A9. Check if all recipes have been fetched; if so, save and resolve
